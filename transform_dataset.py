...
train_pub_data = json.load(open('data/train/train_pub.json', 'r', encoding='utf-8'))
train_author_data = json.load(open('data/train/train_author.json', 'r', encoding='utf-8'))
...
for name, author in train_author_data.items():
...
with open('data/train/train_author_fix.json', 'w') as f:
    json.dump(train_author_data, f, indent='\t')

with open('data/train/train_pub_fix.json', 'w') as f:
